...
list(APPEND Poco_FIND_LIBRARIES "PocoFoundation")
if(Poco_FIND_COMPONENTS)
    foreach(component ${Poco_FIND_COMPONENTS})
        list(APPEND Poco_FIND_LIBRARIES "Poco${component}")
    endforeach(component)
endif(Poco_FIND_COMPONENTS)
...
IF(Poco_INCLUDE_DIR)
  ...
  foreach(library ${Poco_FIND_LIBRARIES})
    FIND_LIBRARY(Poco_LIBRARY_${library}_Found NAMES ${library} PATH_SUFFIXES ${SUFFIX_FOR_LIBRARY_PATH} PATHS
      # Look in other places.
      ${Poco_INCLUDE_DIR}
      ${Poco_DIR_SEARCH}
      # Help the user find it if we cannot.
    ...
    if(Poco_LIBRARY_${library}_Found)
      list(APPEND Poco_LIBRARIES_TMP ${Poco_LIBRARY_${library}_Found})
    endif(Poco_LIBRARY_${library}_Found)
  endforeach(library)
  set( Poco_LIBRARIES ${Poco_LIBRARIES_TMP} CACHE FILEPATH "Poco libraries names" FORCE )
  endif()

  IF ( NOT Poco_LIBRARY_DIR )
    FIND_LIBRARY(Poco_LIBRARY_DIR_TMP NAMES ${Poco_FIND_LIBRARIES} PATH_SUFFIXES ${SUFFIX_FOR_LIBRARY_PATH} PATHS
...
IF(NOT Poco_FOUND)
  IF(Poco_FIND_QUIETLY)
    MESSAGE(STATUS "Poco was not found, but continuing anyway. ${Poco_DIR_MESSAGE}")
...
IF(NOT Poco_FIND_QUIETLY AND Poco_FOUND)
  message(STATUS "Poco found at ${Poco_INCLUDE_DIR} and lib dir ${Poco_LIBRARY_DIR}")
ENDIF(NOT Poco_FIND_QUIETLY AND Poco_FOUND)
